...
variable "rds_sn_group_name" {
    type    = string
    default = "rds-sn-group-vicente"
}

variable "rds_param_group_name" {
    type    = string
    default = "rds-param-group-vicente"
}

variable "rds_dbname" {
    type    = string
    default = "rdsdbvicente"
}
...
variable "ec2_lb_name" {
    type    = string
    default = "ec2-lb-vicente"
}

variable "ec2_lb_tg_name" {
    type    = string
    default = "ec2-lb-tg-vicente"
}

variable "ec2_asg_name" {
    type    = string
    default = "ec2-asg-vicente"
}

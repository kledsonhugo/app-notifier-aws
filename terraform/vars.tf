...
variable "rds_identifier" {
    type    = string
    default = "rds-henrique"
}

variable "rds_sn_group_name" {
    type    = string
    default = "rds-sn-group-henrique"
}

variable "rds_param_group_name" {
    type    = string
    default = "rds-param-group-henrique"
}

variable "rds_dbname" {
    type    = string
    default = "rdsdbhenrique"
}
...
variable "ec2_lb_name" {
    type    = string
    default = "ec2-lb-henrique"
}

variable "ec2_lb_tg_name" {
    type    = string
    default = "ec2-lb-tg-henrique"
}

variable "ec2_asg_name" {
    type    = string
    default = "ec2-asg-henrique"
}

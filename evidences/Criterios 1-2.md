...
module.network.aws_vpc.vpc: Creation complete after 14s [id=vpc-08b67c8c9b8539725]
...
module.network.aws_route_table.rt_priv: Creation complete after 2s [id=rtb-0888339245eeb2d36]
module.network.aws_internet_gateway.igw: Creation complete after 2s [id=igw-097dc8d925ae1fa92]
module.network.aws_route_table.rt_pub: Creating...
module.network.aws_subnet.sn_priv_az1: Creation complete after 2s [id=subnet-066050492cf586daa]
module.network.aws_subnet.sn_priv_az2: Creation complete after 2s [id=subnet-0b2cb29485cddfbdb]
...
module.network.aws_route_table_association.rt_pub_sn_priv_az2: Creation complete after 1s [id=rtbassoc-0d5b1b3203dcbfd29]
module.network.aws_route_table_association.rt_pub_sn_priv_az1: Creation complete after 1s [id=rtbassoc-06a7041ad9869b3f6]
module.compute.aws_lb_target_group.ec2_lb_tg: Creation complete after 3s [id=arn:aws:elasticloadbalancing:us-east-1:843994971707:targetgroup/ec2-lb-tg-notifier/6c3b0dc3f9ca4612]
module.database.aws_db_subnet_group.rds_sn_group: Creation complete after 2s [id=rds-sn-group-notifier]
module.network.aws_route_table.rt_pub: Creation complete after 2s [id=rtb-088c1e3416563735f]
module.network.aws_security_group.vpc_sg_pub: Creation complete after 5s [id=sg-07ed8ba7235720eec]
module.network.aws_security_group.vpc_sg_priv: Creation complete after 5s [id=sg-0bbe48722f5163b60]
...
module.network.aws_subnet.sn_pub_az2: Creation complete after 12s [id=subnet-0dcb43b21df367c56]
module.network.aws_route_table_association.rt_pub_sn_pub_az2: Creating...
module.network.aws_subnet.sn_pub_az1: Creation complete after 13s [id=subnet-04c5b7e4af867b2af]
module.network.aws_route_table_association.rt_pub_sn_pub_az1: Creating...
module.compute.aws_lb.ec2_lb: Creating...
module.network.aws_route_table_association.rt_pub_sn_pub_az2: Creation complete after 1s [id=rtbassoc-00064dee36b1bd69a]
module.network.aws_route_table_association.rt_pub_sn_pub_az1: Creation complete after 0s [id=rtbassoc-0c5c183cf86520c0b]
...
module.compute.aws_lb.ec2_lb: Creation complete after 2m14s [id=arn:aws:elasticloadbalancing:us-east-1:843994971707:loadbalancer/app/ec2-lb-notifier/f772909c7d59c06e]        
module.compute.aws_lb_listener.ec2_lb_listener: Creating...
module.compute.aws_lb_listener.ec2_lb_listener: Creation complete after 0s [id=arn:aws:elasticloadbalancing:us-east-1:843994971707:listener/app/ec2-lb-notifier/f772909c7d59c06e/515e79b84cffcdc3]
...
module.database.aws_db_instance.rds_dbinstance: Creation complete after 6m21s [id=rds-notifier]
module.compute.data.template_file.user_data: Reading...
module.compute.data.template_file.user_data: Read complete after 0s [id=389b5e5d12a4d7573ee10996240b7745e8ac9b41e3a6564e845081f34621361b]
module.compute.aws_launch_template.ec2_lt: Creating...
module.compute.aws_launch_template.ec2_lt: Creation complete after 2s [id=lt-09cd29b1774bdb575]
...
data "template_file" "user_data" {
    id       = "389b5e5d12a4d7573ee10996240b7745e8ac9b41e3a6564e845081f34621361b"
    rendered = <<-EOT
        #!/bin/bash
        ...
        cat <<EOT >> /var/www/config.php
        <?php
        define('DB_SERVER', 'rds-notifier.cmmqvocnpcrh.us-east-1.rds.amazonaws.com:3306');
    ...
    vars     = {
        ...
        "rds_dbpassword" = "rdsdbadminpwd"
        "rds_dbuser"     = "rdsdbadmin"
        "rds_endpoint"   = "rds-notifier.cmmqvocnpcrh.us-east-1.rds.amazonaws.com:3306"
    }
}

# module.compute.aws_autoscaling_group.ec2_asg:
resource "aws_autoscaling_group" "ec2_asg" {
    arn                       = "arn:aws:autoscaling:us-east-1:843994971707:autoScalingGroup:c6aa814f-3674-4012-879b-9d2fef1ce186:autoScalingGroupName/ec2-asg-notifier"      
    availability_zones        = [
        "us-east-1a",
        "us-east-1c",
    ]
    ...
    target_group_arns         = [
        "arn:aws:elasticloadbalancing:us-east-1:843994971707:targetgroup/ec2-lb-tg-notifier/6c3b0dc3f9ca4612",
    ]
    vpc_zone_identifier       = [
        "subnet-04c5b7e4af867b2af",
        "subnet-0dcb43b21df367c56",
    ]
    wait_for_capacity_timeout = "10m"

    launch_template {
        id      = "lt-09cd29b1774bdb575"
        name    = "ec2-lt-notifier"
        version = "$Latest"
    }
}
...
resource "aws_launch_template" "ec2_lt" {
    arn                     = "arn:aws:ec2:us-east-1:843994971707:launch-template/lt-09cd29b1774bdb575"
    default_version         = 1
    ...
    name                    = "ec2-lt-notifier"
    tags_all                = {}
    user_data               = ""
    vpc_security_group_ids  = [
        "sg-07ed8ba7235720eec",
    ]
}

# module.compute.aws_lb.ec2_lb:
resource "aws_lb" "ec2_lb" {
    arn                                         = "arn:aws:elasticloadbalancing:us-east-1:843994971707:loadbalancer/app/ec2-lb-notifier/f772909c7d59c06e"
    arn_suffix                                  = "app/ec2-lb-notifier/f772909c7d59c06e"
    desync_mitigation_mode                      = "defensive"
    dns_name                                    = "ec2-lb-notifier-1344683431.us-east-1.elb.amazonaws.com"
    drop_invalid_header_fields                  = false
    ...
    enable_waf_fail_open                        = false
    enable_xff_client_port                      = false
    id                                          = "arn:aws:elasticloadbalancing:us-east-1:843994971707:loadbalancer/app/ec2-lb-notifier/f772909c7d59c06e"
    idle_timeout                                = 60
    internal                                    = false
    ...
    subnet_mapping {
        subnet_id = "subnet-04c5b7e4af867b2af"
    }
    subnet_mapping {
        subnet_id = "subnet-0dcb43b21df367c56"
    }
}

# module.compute.aws_lb_listener.ec2_lb_listener:
resource "aws_lb_listener" "ec2_lb_listener" {
    arn               = "arn:aws:elasticloadbalancing:us-east-1:843994971707:listener/app/ec2-lb-notifier/f772909c7d59c06e/515e79b84cffcdc3"
    id                = "arn:aws:elasticloadbalancing:us-east-1:843994971707:listener/app/ec2-lb-notifier/f772909c7d59c06e/515e79b84cffcdc3"
    load_balancer_arn = "arn:aws:elasticloadbalancing:us-east-1:843994971707:loadbalancer/app/ec2-lb-notifier/f772909c7d59c06e"
    port              = 80
    protocol          = "HTTP"
    tags_all          = {}
    ...
    default_action {
        order            = 1
        target_group_arn = "arn:aws:elasticloadbalancing:us-east-1:843994971707:targetgroup/ec2-lb-tg-notifier/6c3b0dc3f9ca4612"
        type             = "forward"
    }
}
...
resource "aws_lb_target_group" "ec2_lb_tg" {
    arn                                = "arn:aws:elasticloadbalancing:us-east-1:843994971707:targetgroup/ec2-lb-tg-notifier/6c3b0dc3f9ca4612"
    arn_suffix                         = "targetgroup/ec2-lb-tg-notifier/6c3b0dc3f9ca4612"
    connection_termination             = false
    deregistration_delay               = "300"
    id                                 = "arn:aws:elasticloadbalancing:us-east-1:843994971707:targetgroup/ec2-lb-tg-notifier/6c3b0dc3f9ca4612"
    ip_address_type                    = "ipv4"
    lambda_multi_value_headers_enabled = false
...
resource "aws_db_instance" "rds_dbinstance" {
    address                               = "rds-notifier.cmmqvocnpcrh.us-east-1.rds.amazonaws.com"
    allocated_storage                     = 20
    apply_immediately                     = false
    arn                                   = "arn:aws:rds:us-east-1:843994971707:db:rds-notifier"
    auto_minor_version_upgrade            = true
    availability_zone                     = "us-east-1a"
    ...
    endpoint                              = "rds-notifier.cmmqvocnpcrh.us-east-1.rds.amazonaws.com:3306"
    engine                                = "mysql"
    engine_version                        = "8.0.23"
    ...
    listener_endpoint                     = []
    maintenance_window                    = "sun:04:22-sun:04:52"
    master_user_secret                    = []
    max_allocated_storage                 = 0
    monitoring_interval                   = 0
    multi_az                              = false
    ...
    publicly_accessible                   = false
    replicas                              = []
    resource_id                           = "db-GDUH7RUHS3FS3SJVPLZIU3RKJY"
    skip_final_snapshot                   = true
    status                                = "available"
    ...
    username                              = "rdsdbadmin"
    vpc_security_group_ids                = [
        "sg-0bbe48722f5163b60",
    ]
}

# module.database.aws_db_parameter_group.rds_param_group:
resource "aws_db_parameter_group" "rds_param_group" {
    arn         = "arn:aws:rds:us-east-1:843994971707:pg:rds-param-group-notifier"
    description = "Managed by Terraform"
    family      = "mysql8.0"
...
resource "aws_db_subnet_group" "rds_sn_group" {
    arn                     = "arn:aws:rds:us-east-1:843994971707:subgrp:rds-sn-group-notifier"
    description             = "Managed by Terraform"
    id                      = "rds-sn-group-notifier"
    name                    = "rds-sn-group-notifier"
    subnet_ids              = [
        "subnet-066050492cf586daa",
        "subnet-0b2cb29485cddfbdb",
    ]
...
resource "aws_internet_gateway" "igw" {
    arn      = "arn:aws:ec2:us-east-1:843994971707:internet-gateway/igw-097dc8d925ae1fa92"
    id       = "igw-097dc8d925ae1fa92"
...
resource "aws_route_table" "rt_priv" {
    arn              = "arn:aws:ec2:us-east-1:843994971707:route-table/rtb-0888339245eeb2d36"
    id               = "rtb-0888339245eeb2d36"
    owner_id         = "843994971707"
    propagating_vgws = []
    route            = []
    tags_all         = {}
...
resource "aws_route_table" "rt_pub" {
    arn              = "arn:aws:ec2:us-east-1:843994971707:route-table/rtb-088c1e3416563735f"
    id               = "rtb-088c1e3416563735f"
    owner_id         = "843994971707"
    propagating_vgws = []
    route            = [
        {
            ...
            destination_prefix_list_id = ""
            egress_only_gateway_id     = ""
            gateway_id                 = "igw-097dc8d925ae1fa92"
            instance_id                = ""
            ipv6_cidr_block            = ""
            local_gateway_id           = ""
            nat_gateway_id             = ""
...
resource "aws_route_table_association" "rt_pub_sn_priv_az1" {
    id             = "rtbassoc-06a7041ad9869b3f6"
    route_table_id = "rtb-0888339245eeb2d36"
    subnet_id      = "subnet-066050492cf586daa"
}

# module.network.aws_route_table_association.rt_pub_sn_priv_az2:
resource "aws_route_table_association" "rt_pub_sn_priv_az2" {
    id             = "rtbassoc-0d5b1b3203dcbfd29"
    route_table_id = "rtb-0888339245eeb2d36"
    subnet_id      = "subnet-0b2cb29485cddfbdb"
}

# module.network.aws_route_table_association.rt_pub_sn_pub_az1:
resource "aws_route_table_association" "rt_pub_sn_pub_az1" {
    id             = "rtbassoc-0c5c183cf86520c0b"
    route_table_id = "rtb-088c1e3416563735f"
    subnet_id      = "subnet-04c5b7e4af867b2af"
}

# module.network.aws_route_table_association.rt_pub_sn_pub_az2:
resource "aws_route_table_association" "rt_pub_sn_pub_az2" {
    id             = "rtbassoc-00064dee36b1bd69a"
    route_table_id = "rtb-088c1e3416563735f"
    subnet_id      = "subnet-0dcb43b21df367c56"
}
...
resource "aws_security_group" "vpc_sg_priv" {
    arn                    = "arn:aws:ec2:us-east-1:843994971707:security-group/sg-0bbe48722f5163b60"
    description            = "Managed by Terraform"
    egress                 = [
        {
            cidr_blocks      = [
    ...
    name                   = "terraform-20230429044140484600000001"
...
resource "aws_security_group" "vpc_sg_pub" {
    arn                    = "arn:aws:ec2:us-east-1:843994971707:security-group/sg-07ed8ba7235720eec"
    description            = "Managed by Terraform"
    egress                 = [
        {
            cidr_blocks      = [
    ...
    name                   = "terraform-20230429044140494000000002"
    name_prefix            = "terraform-"
    owner_id               = "843994971707"
    revoke_rules_on_delete = false
    tags_all               = {}
...
resource "aws_subnet" "sn_priv_az1" {
    arn                                            = "arn:aws:ec2:us-east-1:843994971707:subnet/subnet-066050492cf586daa"
    assign_ipv6_address_on_creation                = false
    availability_zone                              = "us-east-1a"
...
resource "aws_subnet" "sn_priv_az2" {
    arn                                            = "arn:aws:ec2:us-east-1:843994971707:subnet/subnet-0b2cb29485cddfbdb"
    assign_ipv6_address_on_creation                = false
    availability_zone                              = "us-east-1c"
...
resource "aws_subnet" "sn_pub_az1" {
    arn                                            = "arn:aws:ec2:us-east-1:843994971707:subnet/subnet-04c5b7e4af867b2af"
    assign_ipv6_address_on_creation                = false
    availability_zone                              = "us-east-1a"
    availability_zone_id                           = "use1-az2"
    cidr_block                                     = "10.0.1.0/24"
...
resource "aws_subnet" "sn_pub_az2" {
    arn                                            = "arn:aws:ec2:us-east-1:843994971707:subnet/subnet-0dcb43b21df367c56"
    assign_ipv6_address_on_creation                = false
    availability_zone                              = "us-east-1c"
    availability_zone_id                           = "use1-az6"
    cidr_block                                     = "10.0.2.0/24"
...
resource "aws_vpc" "vpc" {
    arn                                  = "arn:aws:ec2:us-east-1:843994971707:vpc/vpc-08b67c8c9b8539725"
    assign_generated_ipv6_cidr_block     = false
    cidr_block                           = "10.0.0.0/16"
    default_network_acl_id               = "acl-02081fe42cf33586f"
    default_route_table_id               = "rtb-0d629bfa3c71aa986"
    default_security_group_id            = "sg-0af84e787c76aa926"
    ...
    id                                   = "vpc-08b67c8c9b8539725"
    instance_tenancy                     = "default"
    ipv6_netmask_length                  = 0
    main_route_table_id                  = "rtb-0d629bfa3c71aa986"
    owner_id                             = "843994971707"
    tags_all                             = {}
}
```
...
<div>
<br>
<h2> Aplicação rodando em PHP 
</div>

![Notifier](/images/app%20rodando%20PHP.png)